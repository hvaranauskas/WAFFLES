...
public class StringFormatter {
    ...
    public static Object[] accents;

    static {
        // Initialise things here
        accents = new Object[accentAndConvertedAccent.length];
        for (int i = 0; i < accentAndConvertedAccent.length; i++) {
            accents[i] = accentAndConvertedAccent[i][0].charAt(0);
        }
    }
    ...
    public static String convertAccentsFaster(String str) {
        ...
        for (int i = 0; i < str.length(); i++) {
            char c = str.charAt(i);
            if (c >= '§') {
                int index = BinarySearch.search(accents,c,0,accentAndConvertedAccent.length,true);
                str = str.replace(c,accentAndConvertedAccent[index][1].charAt(0));
            }
        }
        return str;
    }
